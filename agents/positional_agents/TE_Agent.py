...
def get_TE_aggregate_stats(player_id: int) -> dict:
    ...
    return{
        ...
        "Season Total Receiving 2 Point Conversions": stats['breakdown'].get('receiving 2PtConversions', 0),
...
te_agent = LlmAgent(
    ...
    1. Retrieve the player's core season metrics: Call 'get_TE_aggregate_stats' and 'get_TE_average_stats' using the value found in player_id as the parameter to access the data
    ...
    **Output Format**
    ...
    tools=[
        ...
        FunctionTool(get_TE_aggregate_stats),
        FunctionTool(get_TE_average_stats),
