...
qb_agent = LlmAgent(
    ...
    1. Retrieve the player's core season metrics: Call 'get_aggregate_stats' and 'get_average_stats' using the value found in player_id and position='QB' as the parameters to access the data
    ...
    **MUST BE IN VALID JSON ARRAY FORMAT WITH NO MARKDOWN FORMATTING OR CODE BLOCKS**      
    ...
    [
        {{
            ...
            "opponent_ranking_against_QB": 'opponent ranking'
            "reasoning": 'reasoning'
